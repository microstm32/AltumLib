...
'		If Graph.ChartType = "BAR" And Items.Size = 1 And Points.Size <= 7 Then
		If Graph.ChartType = "BAR" And Items.Size = 1 Or Graph.ChartType = "STACKED_BAR" Then
...
'		If Texts.ScaleTextHeight + 4dip > Graph.BarWidth Then	'???
		If Texts.ScaleTextHeight * 1.5 + 4dip > Graph.BarWidth Then	'???
			...
			LocalTextSize = Texts.ScaleTextSize * Graph.BarWidth / Texts.ScaleTextHeight / 1.5	'???
...
'			xt = Graph.Left + Graph.XOffset + (i + 0.5) * Graph.XInterval + 0.28 * LocalTextHeight
			xt = Graph.Left + Graph.XOffset + (i + 0.5) * Graph.XInterval + 0.3 * LocalTextHeight
